/* ═══ GUEST DATA ═══ */
  const GUESTS_BACKUP = [
    ...
    { initials:"MW", name:"Magatha Wang", photo:"assets/photos/maggie-wang.jpg", role:"MA Candidate @ TUM", bio:"Likes: Taking the most difficult path.", status:"In a Relationship", nationalities:["Taiwan","USA"], acquaintance:14, passports:2, room:"1K3", bunking:"Nolan Betts", age:"Skibidi iPad Kid" },
    { initials:"NB", name:"Nolan Betts", photo:"assets/photos/nolan-betts.jpg", role:"Lead Software Engineer @ Capital One", bio:"Likes: Beer, boys and ball. Dislikes: Cars.", status:"In a Relationship", nationalities:["USA"], acquaintance:7, passports:1, room:"1K3", bunking:"Magatha Wang", age:"Old Coot" },
  ...
  const GUESTS = [
    ...
    {name:"Nolan Betts",initials:"NB",url:"https://www.linkedin.com/in/nolanbetts",age:"Old Coot",role:"Lead Software Engineer @ Capital One",bio:"losing toenails · Cars",room:"1K3",bunking:"Magatha Wang",status:"In a relationship",passports:1,acquaintance:7,nationalities:["USA"]},
    {name:"Magatha Wang",initials:"MW",url:"https://contactout.com/Maggie-Wang-86630684",age:"Skibidi iPad kid",role:"MA candidate @ TUM",bio:"playing life on hard-mode · Convenience",room:"1K3",bunking:"Nolan Betts",status:"In a relationship",passports:2,acquaintance:14,nationalities:["Taiwan","USA"],photoPosition:"center center"},
    ...
    {name:"Ashley Leonard",initials:"AL",url:"https://www.linkedin.com/in/ashley-leonard-4b0745164/",age:"Skibidi iPad kid",role:"Supervisor, Global Transformation @ McDonald's",bio:"To be edged · Edges",room:"2K1",bunking:"Jess Cao",status:"In a relationship",passports:1,acquaintance:0,nationalities:["USA"]},
    {name:"Riva Han",initials:"RH",url:"https://www.linkedin.com/in/riva-han",age:"Skibidi iPad kid",role:"Judicial Law Clerk @ SD",bio:"Life-threatening hobbies on her down time · Donald Trump",room:"2K2",bunking:"Paige Amormino",status:"Single",passports:1,acquaintance:17,nationalities:["USA"]},
    ...
    {name:"Hugo Grochau",initials:"HG",url:"https://www.linkedin.com/in/hugogrochau/",age:"Old Coot",role:"Staff Software Engineer @ Meta",bio:"Taken Women · Licking da pussy",room:"3S4",bunking:"NA",status:"Single",passports:3,acquaintance:1,nationalities:["Brazil","Italy","Australia"]},
    {name:"Cameron Rhodes",initials:"CR",url:"https://www.linkedin.com/in/cameron-rhodes-2016a1169",age:"Old Coot",role:"Account Executive @ Velaris",bio:"Volleyball and tall blondes that play volleyball · Ginger CROs",room:"2T5",bunking:"Jordi Soxa",status:"Single",passports:1,acquaintance:3,nationalities:["UK"]},
    ...
    {name:"Jordi Soxa",initials:"JSo",url:"https://www.linkedin.com/in/jordisoxa",age:"Old Coot",role:"Product Design Lead @ Meta",bio:"Running away to SE Asia · hot, steamy reunions with bad past decisions",room:"2T5",bunking:"Cameron Rhodes",status:"Single",passports:2,acquaintance:1,nationalities:["Venezuela","UK"]},
