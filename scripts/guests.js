/* ═══ GUEST DATA ═══ */
  ...
  const GUESTS = [
    ...
    {name:"Jordan Smith",initials:"JS",age:"Old Coot",role:"Procurements and Contracts Solicitor @ Chelsea and Kensington Borough",bio:"Good music, Jamaican food, and chill walks with Taro · Child solicitors",room:"1K2",status:"In a relationship",passports:1,acquaintance:9,nationalities:["UK"]},
    ...
    {name:"Maggie Wang",initials:"MW",age:"Skibidi iPad kid",role:"MA candidate @ TUM",bio:"playing life on hard-mode · Convenience",room:"1K3",status:"In a relationship",passports:2,acquaintance:14,nationalities:["Taiwan","USA"]},
    {name:"Kevin Chacon",initials:"KC",age:"Old Coot",role:"ADHD-fueled entrepreneur",bio:"Spawning new side quests · the main quest",room:"1K4",status:"In a relationship",passports:2,acquaintance:3,nationalities:["Uruguay","UK"]},
    {name:"Gabby Kinder",initials:"GK",age:"Old Coot",role:"Carbon Research Lead @ London Stock Exchange",bio:"Chubby men? · When Kevin becomes a chubby man",room:"1K4",status:"In a relationship",passports:1,acquaintance:4,nationalities:["UK"]},
