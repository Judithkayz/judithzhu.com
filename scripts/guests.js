/* ═══ GUEST DATA ═══ */
  ...
  const GUESTS = [
    {name:"Calypso",initials:"C",age:"Baby",role:"Stay at home dog",bio:"Herding children and dogs, Attention, Confrontation · Being chased by children and dogs, attention, confrontation",room:"1K1",status:"Dawg",passports:0,acquaintance:3.5,nationalities:[]},
    {name:"Oliver Laso",initials:"OL",age:"Old Coot",role:"Staff Software Engineer @ Palantir",bio:"Calypso · Whatever Calypso dislikes",room:"1K1",status:"Dawg",passports:3,acquaintance:10,nationalities:["UK","Spain","Germany"]},
    {name:"Terrence Rice",initials:"TR",age:"Old Coot",role:"HedgeFund Analyst @ Systems 2 Capital",bio:"BeepBoop · The smell of fermentation",room:"1K2",status:"In a relationship",passports:1,acquaintance:12,nationalities:["USA"]},
    {name:"Jordan Smith",initials:"JS",age:"Old Coot",role:"Child Solicitor @ Law",bio:"Saving Children · People who are mean to children",room:"1K2",status:"In a relationship",passports:1,acquaintance:9,nationalities:["UK"]},
    {name:"Nolan Betts",initials:"NB",age:"Old Coot",role:"Lead Software Engineer @ Capital One",bio:"losing toenails · Cars",room:"1K3",status:"In a relationship",passports:1,acquaintance:7,nationalities:["USA"]},
    {name:"Maggie Wang",initials:"MW",age:"Skibidi iPad kid",role:"MA candidate @ TUM",bio:"playing life on hard-mode · Convenience",room:"1K3",status:"In a relationship",passports:2,acquaintance:14,nationalities:["Taiwan","USA"],photoPosition:"center center",photoZoom:1.15},
    {name:"Kevin Chacon",initials:"KC",age:"Old Coot",role:"ADHD-fueled entrepreneur",bio:"Spawning new side quests · the main quest",room:"1K4",status:"In a relationship",passports:2,acquaintance:3,nationalities:["Uruguay","UK"],photoPosition:"center center",photoZoom:1.15},
    {name:"Gabby Kinder",initials:"GK",age:"Old Coot",role:"Carbon Research Lead @ London Stock Exchange",bio:"Chubby men? · When Kevin becomes a chubby man",room:"1K4",status:"In a relationship",passports:1,acquaintance:4,nationalities:["UK"],photoPosition:"center center",photoZoom:1.15},
    {name:"Alex Tupper",initials:"AT",age:"Old Coot",role:"Co-Founder @ Kettel",bio:"Public speaking when nobody is looking · AI",room:"1T5",status:"Married",passports:1,acquaintance:1,nationalities:["UK"]},
    {name:"Cesar Lamas",initials:"CL",age:"Old Coot",role:"Software Engineer @ Airbus",bio:"Red flags · Anything that doesn't stress him out",room:"1T5",status:"In a relationship",passports:1,acquaintance:7,nationalities:["Spain"]},
    {name:"Jess Cao",initials:"JC",age:"Old Coot",role:"Resident @ UChicago",bio:"Drugs, Alcohol, and pussy · Pussies",room:"2K1",status:"In a relationship",passports:1,acquaintance:14,nationalities:["USA"]},
    {name:"Ashley Leonard",initials:"AL",age:"Skibidi iPad kid",role:"PhD Candidate @ UC Berkeley",bio:"To be edged · Edges",room:"2K1",status:"In a relationship",passports:1,acquaintance:12,nationalities:["USA"]},
    {name:"Dino Mujkic",initials:"DM",age:"Old Coot",role:"Staff Software Engineer @ Meta",bio:"War, Napoleon, and saying \"I'm easy\" · showing up on time or anywhere close to the proposed time",room:"2K2",status:"In a relationship",passports:1,acquaintance:4,nationalities:["Bosnia"]},
    {name:"Verna Gao",initials:"VG",age:"Old Coot",role:"Channel 4 Chef + Influencer",bio:"Cooking, eating, travelling · Internet trolls",room:"2K2",status:"In a relationship",passports:2,acquaintance:0.5,nationalities:["UK","China"]},
    {name:"Lauren Chin",initials:"LC",age:"Old Coot",role:"R&R",bio:"English men · English weather",room:"2K3",status:"In a relationship",passports:2,acquaintance:13,nationalities:["UK","USA"]},
    {name:"Dan Forman",initials:"DF",age:"Old Coot",role:"Global Marketing Director - Oncology @ GSK",bio:"Being exactly Lauren's type · poor form (on and off the court)",room:"2K3",status:"In a relationship",passports:1,acquaintance:1,nationalities:["UK"]},
    {name:"Gautier Dagan",initials:"GD",age:"Old Coot",role:"Member of Technical Staff @ Cohere",bio:"Cheese & being called Dr. Dagan · People who are late",room:"2K4",status:"Married",passports:2,acquaintance:4,nationalities:["France","UK"]},
    {name:"Lizzie Roberts",initials:"LR",age:"Old Coot",role:"Deputy News Editor @ The Sunday Times",bio:"Running the hottest gossip in the UK · Saturdays",room:"2K4",status:"Married",passports:1,acquaintance:4,nationalities:["UK"]},
    {name:"Jordi Soxa",initials:"JSo",age:"Old Coot",role:"Product Design Lead @ Meta",bio:"Running away to SE Asia · hot, steamy reunions with bad past decisions",room:"2T5",status:"Single",passports:2,acquaintance:1,nationalities:["Venezuela","UK"]},
    {name:"Hugo Grochau",initials:"HG",age:"Old Coot",role:"Staff Software Engineer @ Meta",bio:"Taken Women · Licking da pussy",room:"2T5",status:"Single",passports:3,acquaintance:1,nationalities:["Brazil","Italy","Australia"]},
    {name:"Riva Han",initials:"RH",age:"Skibidi iPad kid",role:"Judicial Law Clerk @ SD",bio:"Saving immigrants and life-threatening hobbies on her down time · Donald Trump",room:"3K1",status:"In a relationship",passports:1,acquaintance:17,nationalities:["USA"]},
    {name:"Paige Amormino",initials:"PA",age:"Skibidi iPad kid",role:"Post Doc @ Penn State",bio:"Cats and hot cheetos · When her cats eat her hot cheetos",room:"3K1",status:"In a relationship",passports:1,acquaintance:13,nationalities:["USA"]},
    {name:"Leila Fujiwara",initials:"LF",age:"Old Coot",role:"Associate @ McDermott Will & Emery",bio:"Self care · The brakes",room:"3K2",status:"Single",passports:1,acquaintance:12,nationalities:["Japan"]},
    {name:"Aimee Gutierrez",initials:"AG",age:"Old Coot",role:"Sr. Specialist Procurement Category Manager @ Nestle",bio:"Her new baby · Being tackled",room:"3K2",status:"Married",passports:2,acquaintance:16,nationalities:["USA","Mexico"]},
    {name:"Danni Pair",initials:"DP",age:"Old Coot",role:"Group Account Supervisor @ Synapse",bio:"Chinese men · Slavic men",room:"3K3",status:"In a relationship",passports:1,acquaintance:11,nationalities:["USA"]},
    {name:"Carina Escobar",initials:"CE",age:"Old Coot",role:"Project Manager @ Maslansky + Partners",bio:"Getting injured · Undercooked meat",room:"3K3",status:"Single",passports:1,acquaintance:12,nationalities:["USA"]},
    {name:"Yadi Yang",initials:"YY",age:"Skibidi iPad kid",role:"Product Manager @ Boeing",bio:"Selling defence secrets to china · Normal diet methods",room:"3K4",status:"Single",passports:1,acquaintance:12,nationalities:["China"]},
    {name:"Jay Nam",initials:"JN",age:"Old Coot",role:"MBA Candidate @ Harvard Business School",bio:"Money, Uber drivers, Bears, Social chaos with hot gays · being told \"I don't see color\"",room:"3K4",status:"Single",passports:1,acquaintance:14,nationalities:["USA"]},
    {name:"Jay Viray",initials:"JV",age:"Old Coot",role:"Fine Arts Underwriter @ Berkeley Asset Protection",bio:"Falling off the wagon and indulging in drinking, smoking and Mcdonalds · the day after falling off the wagon",room:"3T5",status:"Single",passports:1,acquaintance:12,nationalities:["USA"]},
    {name:"Cameron Rhodes",initials:"CR",age:"Old Coot",role:"Account Executive @ Velaris",bio:"Volleyball and tall blondes that play volleyball · Ginger CROs",room:"3T5",status:"Single",passports:1,acquaintance:3,nationalities:["UK"]},
  ];
